...
chart_data = pd.DataFrame(
    np.random.randn(3, 3),
    columns=["부적절한 단어 점수", "비속어 점수", "대본일치성 점수"],
    index=["부적절한 단어 점수","비속어 점수","대본일치성 점수"]
    )
...
st.write(slang_filter(text_list))


print("비속어 단어 점수: ", fuck_lang_filter(text_list))
